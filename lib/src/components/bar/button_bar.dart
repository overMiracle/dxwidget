...
class DxButtonBar extends StatelessWidget {
  /// Create buttons bar for all types of buttons.
  /// check [DxButton] and [DxIconButton]
  const DxButtonBar({
    Key? key,
  ...
  ///
  /// For widget, if [direction] is [Axis.horizontal], the default, the
  ...
  ///
  /// For widget, if [alignment] is [WrapAlignment.center], the children in
  ...
  ///
  /// For widget, if [spacing] is 10.0, the children will be spaced at least
  ...
  ///
  /// For widget, if [runAlignment] is [WrapAlignment.center], the runs are
  ...
  ///
  /// For widget, if [runSpacing] is 10.0, the runs will be spaced at least
  ...
  /// Typically [DxButton] or [DxIconButton] widgets.
  final List<Widget> children;

  /// How the children within a run should be aligned relative to each other in
  /// the cross axis.
  ///
  /// For widget, if this is set to [WrapCrossAlignment.end], and the

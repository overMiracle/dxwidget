...
/// github地址：https://github.com/Skylled/expansion_tile_card
...
class DxExpansionTileCard extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const DxExpansionTileCard({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<DxExpansionTileCard> createState() => _DxExpansionTileCardState();
}

class _DxExpansionTileCardState extends State<DxExpansionTileCard> with SingleTickerProviderStateMixin {

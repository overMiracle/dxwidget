...
/// [DxTicketPassClipper] is the clipper which extends the [CustomClipper]
...
/// information.
class DxTicketPassClipper extends CustomClipper<Path> {
  DxTicketPassClipper({this.position, this.holeRadius = 16});

...
class AutoSizeTextField extends StatefulWidget {
  ...
  /// See also:
  ///
  ///  * [EditableText.onSubmitted] for an widget of how to handle moving to
  ...
  /// accessibility, but it also needs to be accessible itself.  For widget,
  ...
  @override
  State<AutoSizeTextField> createState() => _AutoSizeTextFieldState();
}
...
class _AutoSizeTextFieldState extends State<AutoSizeTextField> {
  ...
  bool _checkTextFits(TextSpan text, double scale, int? maxLines, BoxConstraints constraints) {
    ...
    double width =
        (widget.decoration.contentPadding != null) ? tp.width + widget.decoration.contentPadding!.horizontal : tp.width;

    double height =
        (widget.decoration.contentPadding != null) ? tp.height + widget.decoration.contentPadding!.vertical : tp.height;

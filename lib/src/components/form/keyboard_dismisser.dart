...
class DxKeyboardDismisser extends StatefulWidget {
  ...
  @override
  State<DxKeyboardDismisser> createState() => _DxKeyboardDismisserState();
...
class _DxKeyboardDismisserState extends State<DxKeyboardDismisser> {
...
/// tree.
class DxIgnoreKeyboardDismisser extends StatelessWidget {
  final Widget child;

  const DxIgnoreKeyboardDismisser({
    Key? key,
    required this.child,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Listener(
      onPointerUp: (_) => DxKeyboardDismisser.ignoreNextTap(context),
      behavior: HitTestBehavior.translucent,
      child: child,
    );
  }

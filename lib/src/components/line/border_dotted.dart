...
///     ),
/// ),
class DxDottedBorder extends BoxBorder {
  final double dottedLength;
  final double dottedSpace;

  const DxDottedBorder({
  ...
  const DxDottedBorder.fromBorderSide(
    BorderSide side, {
    this.dottedLength = 5,
    this.dottedSpace = 3,
  })  : top = side,
  ...
  const DxDottedBorder.symmetric({
  ...
  factory DxDottedBorder.all({
    ...
    return DxDottedBorder.fromBorderSide(side, dottedLength: dottedLength, dottedSpace: dottedSpace);
  }

  static DxDottedBorder merge(DxDottedBorder a, DxDottedBorder b) {
    assert(BorderSide.canMerge(a.top, b.top));
    assert(BorderSide.canMerge(a.right, b.right));
    assert(BorderSide.canMerge(a.bottom, b.bottom));
    assert(BorderSide.canMerge(a.left, b.left));
    return DxDottedBorder(
  ...
  BoxBorder? add(ShapeBorder other, {bool reversed = false}) {
    if (other is DxDottedBorder &&
      ...
      return DxDottedBorder.merge(this, other);
    }
    return null;
  }

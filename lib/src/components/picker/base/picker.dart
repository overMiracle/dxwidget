...
const double _kDefaultDiameterRatio = 2;
...
class DxPicker extends StatefulWidget {
  ...
  @override
  State<DxPicker> createState() => _CupertinoPickerState();
}

class _CupertinoPickerState extends State<DxPicker> {
  ...
  @override
  void didUpdateWidget(DxPicker oldWidget) {
  ...
  Widget _buildMagnifierScreen() {
    final Color foreground =
        widget.backgroundColor.withAlpha((widget.backgroundColor.alpha * _kForegroundScreenOpacityFraction).toInt());

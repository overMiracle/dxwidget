...
class DxCupertinoDateTimeFormatter {
  /// Get default value of date format.
  static String generateDateFormat(DxCupertinoDateTimePickerMode pickerMode) {
    switch (pickerMode) {
  ...
  static List<String> splitDateFormat(String? dateFormat,
      {DxCupertinoDateTimePickerMode? mode, String? dateFormatSeparator}) {
    if (dateFormat == null || dateFormat.isEmpty) {
      return [];
    }
    List<String> result = dateFormat.split(RegExp(dateFormatSeparator ?? DATE_FORMAT_SEPARATOR));
    if (mode == DxCupertinoDateTimePickerMode.datetime) {

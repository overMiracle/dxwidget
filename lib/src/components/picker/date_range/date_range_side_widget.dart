...
class DxDateRangeSideWidget extends StatefulWidget {
  /// 可选最小时间
  ...
  @override
  State<DxDateRangeSideWidget> createState() => _DxDateRangeSideWidgetState();
}

class _DxDateRangeSideWidgetState extends State<DxDateRangeSideWidget> {
  ...
  void _initData(DateTime? initialDateTime, DateTime? minDateTime, DateTime? maxDateTime) {
    DateTime initDateTime = initialDateTime ?? now;
    _minDateTime = widget.minDateTime ?? now;
    _maxDateTime = widget.maxDateTime ?? now;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: _renderDatePickerWidget(themeData),
    );
  }

...
@immutable
class DxTileTimelineAxisPosition {
  const DxTileTimelineAxisPosition({
  ...
  bool operator ==(Object other) =>
      ...
      other is DxTileTimelineAxisPosition &&
  ...
  @override
  String toString() {
    return 'DxTileTimelineAxisPosition{'
...
DxTileTimelineAxisPosition calculateAxisPositioning({
...
DxTileTimelineAxisPosition _alignObject({
  required double totalSize,
  required double objectSize,
  bool alignStart = false,
  bool alignEnd = false,
}) {
  if (alignStart == false && alignEnd == false) throw AssertionError('Either alignTop or alignBottom must be true');

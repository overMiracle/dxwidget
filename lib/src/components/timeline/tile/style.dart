...
class DxTileTimelineIndicatorStyle {
  const DxTileTimelineIndicatorStyle({
    this.width = 20,
    this.height = 20,
    this.indicator,
  ...
  final DxTileTimelineIconStyle? iconStyle;
...
class DxTileTimelineIconStyle {
  DxTileTimelineIconStyle({
  ...
  /// icon size based on the default indicator size. According to ([DxTileTimelineIndicatorStyle.width]).
  final double? fontSize;
}

/// Used to customize the line
class DxTileTimelineLineStyle {
  const DxTileTimelineLineStyle({
    this.color = Colors.grey,
    this.thickness = 4,
  });
  ...
  /// The thickness from the line. It can't be bigger than ([DxTileTimelineIndicatorStyle.width])
  /// and defaults to 4.

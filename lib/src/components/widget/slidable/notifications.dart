...
/// Used to dispatch a DxSlidable notification.
class DxSlidableGroupNotification {
  const DxSlidableGroupNotification._();
...
/// A dispatcher used to dispatch a DxSlidable notification.
...
/// A widget which can dispatch notifications to a group of [DxSlidable] below it.
class SlidableGroupBehavior<T> extends StatefulWidget {
  ...
  @override
  State<SlidableGroupBehavior<T>> createState() => _SlidableGroupBehaviorState<T>();
}
...
///
/// Typically this widget is a child of a [DxSlidable] widget.

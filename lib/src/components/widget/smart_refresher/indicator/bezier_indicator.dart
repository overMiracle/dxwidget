...
class _BezierHeaderState extends RefreshIndicatorState<BezierHeader> with TickerProviderStateMixin {
  ...
  Future<void> readyToRefresh() {
    ...
    final Simulation simulation = SpringSimulation(
        const SpringDescription(mass: 3.4, stiffness: 10000.5, damping: 6), _beizerBounceCtl.value, 0, 1000);
...
///circleType: BezierCircleType.radial,
///)
///```
...
class _RadialPainter extends CustomPainter {
  ...
  _RadialPainter({this.value, this.circleColor, this.circleRadius, this.refreshing});

  ...
  double applyBoundaryConditions(ScrollMetrics position, double value) {
    ...
    if (enablePullUp) {
      ...
      bottomExtra = (!notFull && sliverFooter!.geometry!.scrollExtent != 0) ||
              (notFull &&
                  controller!.footerStatus == RefreshLoadStatus.noMore &&
    ...
    // check user is dragging,it is import,some devices may not bounce with different frame and simple,bouncing return the different velocity

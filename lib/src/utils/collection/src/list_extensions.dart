...
extension ListExtensions<E> on List<E> {
  ...
  int binarySearchByCompare<K>(E element, K Function(E element) keyOf, int Function(K, K) compare,
          [int start = 0, int? end]) =>
      algorithms.binarySearchBy<E, K>(this, keyOf, compare, element, start, end);
  ...
  /// If [start] and [end] are supplied, only the list range from [start] to [end]
  /// is searched, and only that range needs to be sorted.
  int binarySearchBy<K extends Comparable<K>>(E element, K Function(E element) keyOf, [int start = 0, int? end]) =>
      algorithms.binarySearchBy<E, K>(this, keyOf, (a, b) => a.compareTo(b), element, start, end);
  ...
  int lowerBoundByCompare<K>(E element, K Function(E) keyOf, int Function(K, K) compare, [int start = 0, int? end]) =>
  ...
  /// If [start] and [end] are supplied, only that range is searched,
  /// and only that range need to be sorted.
  int lowerBoundBy<K extends Comparable<K>>(E element, K Function(E) keyOf, [int start = 0, int? end]) =>
      algorithms.lowerBoundBy<E, K>(this, keyOf, compareComparable, element, start, end);
  ...
  void sortByCompare<K>(K Function(E element) keyOf, int Function(K a, K b) compare, [int start = 0, int? end]) {
  ...
  ///
  /// Sorts elements from [start] to [end], defaulting to the entire list.
  void sortBy<K extends Comparable<K>>(K Function(E element) keyOf, [int start = 0, int? end]) {
  ...
  /// For widget, to see if a list contains more than one
  ...
  ///
  /// For widget, `[1, 2, 3, 4, 5].slices(2)` returns `[[1, 2], [3, 4], [5]]`.
...
extension ListComparableExtensions<E extends Comparable<E>> on List<E> {
  ...
  /// Returns -1 if [element] does not occur in this list.
  int binarySearch(E element, [int Function(E, E)? compare]) =>
      algorithms.binarySearchBy<E, E>(this, identity, compare ?? compareComparable, element);
  ...
  /// sorted.
  int lowerBound(E element, [int Function(E, E)? compare]) =>
      algorithms.lowerBoundBy<E, E>(this, identity, compare ?? compareComparable, element);
  ...
  void sortRange(int start, int end, [int Function(E a, E b)? compare]) {
    RangeError.checkValidRange(start, end, length);
    algorithms.quickSortBy<E, E>(this, identity, compare ?? compareComparable, start, end);
  }
}

...
class DxEventBus {
  ...
  /// the listeners at a later simple, after the code creating the event has
  /// completed.
  DxEventBus({
    bool sync = false,
  ...
  ///
  /// An widget would be to use an RxDart Subject as the controller.
  DxEventBus.customController(
    StreamController controller,
  ) : _streamController = controller;

  static DxEventBus? _instance;

  factory DxEventBus._() {
    _instance ??= DxEventBus(sync: true);
    return _instance!;
  }

  static DxEventBus get instance {
    return DxEventBus._();
  }
